...
public class JwtUtil {
    ...
    private Claims extractAllClaims(String token) {
        return Jwts.parserBuilder()
                .setSigningKey(getSecretKey()) // Use the secret key for signing
                .build()
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder()
                ...
                .signWith(getSecretKey(), SignatureAlgorithm.HS256) // Sign with the SecretKey
                .compact();
    }

    // Method to return the SecretKey
